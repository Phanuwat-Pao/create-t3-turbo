...
const buttonVariants = cva(
  "group web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2 flex items-center justify-center rounded-md",
  {
    variants: {
      variant: {
